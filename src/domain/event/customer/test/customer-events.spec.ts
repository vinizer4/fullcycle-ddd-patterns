import EventDispatcher from "../../@shared/impl/event-dispatcher";
import EnviaConsoleLog1Handler from "../handler/envia-console-log1-customer.handler";
...
import AddressVO from "../../../entity/valueObject/addressVO";
...
describe("Customer events tests", () => {
    ...
    it("should log a event handler when customer change address", () => {
        ...
        customer.changeAddress(new AddressVO("Rua 1", 123, "12345678", "São Paulo"));
        ...
        expect(console.log).toHaveBeenCalledWith("Endereço do cliente: 123, Customer 1 alterado para Rua 1, 123, São Paulo, 12345678");
    });
});